...
echo route add -net $CLIENT3_IP netmask $NETMASK3 gw $NAT3_IP eth0 >> setup1/setup.sh
...
echo route add -net $CLIENT4_IP netmask $NETMASK4 gw $NAT4_IP eth0 >> setup3/setup.sh
